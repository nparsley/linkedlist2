...
def reverse_list(list, previous=nil)              
  if list                                     #to change the value of the next_node while traversing the list..start with the head of the list (37)
    ...
    list.next_node = previous                 #stored node iformation...to illustrate this...
